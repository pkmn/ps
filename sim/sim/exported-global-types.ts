...
export type Effect = Ability | Item | ActiveMove | Species | PureEffect | Format;
...
export interface AbilityEventMethods {
...
export interface ItemEventMethods {
...
export interface PureEffectEventMethods {
...
export interface PureEffectData extends EffectData, PureEffectEventMethods, EventMethods, EffectData {
}
...
export interface PokemonModData {

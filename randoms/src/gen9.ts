...
const NoStab = [
	...
	'dragontail', 'eruption', 'explosion', 'fakeout', 'feint', 'flamecharge', 'flipturn', 'iceshard', 'icywind', 'incinerate',
...
export class RandomTeams {
	...
	getDoublesItem(
		...
		if (
			...
			(!moves.has('uturn') || types.includes('Bug') || species.baseStats.atk >= 120) &&
